# Module 6: Deliver & Keep Them

> *All dollar amounts in this playbook are in USD unless otherwise noted.*

---

Getting the customer is the beginning, not the end. Module 4 gave you a working prototype. Module 5 showed you how to land the deal. This module is about what happens after the handshake — because how you deliver determines whether they stay for 12 months or cancel after 3.

The difference between a one-time project and a retained service is operational excellence: monitoring, reporting, communication, and the discipline to make your automation invisible. The best system is the one they forget exists — because it just works.
...
By then you've lost trust. Maybe the customer. Definitely sleep.
...
A heartbeat is the simplest form of monitoring: the automation checks in at regular intervals to prove it's alive.
...
**Better approach — dead man's switch:** Instead of monitoring for heartbeats that arrive, monitor for heartbeats that DON'T arrive. Services like Better Stack, Cronitor, or even a simple cron + Slack check:
...
Every unhandled exception should trigger an immediate notification. Not a log entry you'll read someday. A notification that interrupts you.
...
Here's the complete monitoring cron that covers all three layers for all clients:
...
The monthly ROI report is your insurance policy against cancellation. When the customer gets their bill for $1,500 and simultaneously sees a report showing $4,200 in savings, they don't think about canceling. They think about expanding.
...
6. **Issues & Improvements:** What you fixed, what you're improving next month
...
The customer receives their report automatically. You don't lift a finger. The report sells your service for you every single month.

**Pro tip:** Send the report 1-2 days before the invoice. They see "$4,200 in savings" on Monday. They see your "$1,500 invoice" on Wednesday. The invoice feels small.

---

## 6.3 Customer Onboarding Document

Send this immediately after the customer signs. It sets expectations upfront so there are no surprises.
...
**This Week (Week 1):**
- We'll request access to your [Gmail/CRM/tools] — you'll receive a secure access request via [method]
...
- You'll receive a summary of what the automation would have done
- End of week: go/no-go decision for live deployment

**Week 3-4 (Month 1):**
- Automation goes live
- You'll receive **weekly progress emails** every Friday
...
Switch to the auto-generated monthly ROI report. The customer knows the system is running, they see the numbers, and they don't need weekly reassurance.
...
This message takes 2 minutes. It demonstrates three things: you're monitoring, you fixed it fast, and no data was lost. That's trust in a text message.
...
- Propose expansions: "Based on what I've seen, automating [X] could save you another [Y] hours/month. Want me to scope it?"

Quarterly reviews are your upsell mechanism. They're not sales calls — they're value reviews that naturally surface expansion opportunities.
...
3. **Creates revenue** — more work from existing customers is the cheapest growth
...
Things will break. APIs change without warning. PDF formats shift. Rate limits tighten. A server runs out of disk space at 4 AM. This isn't a matter of "if" — it's "when."

As a solo operator (or small team), you need a lightweight incident response process. Not a 50-page runbook. A checklist.
...
2. **Assess severity:**
   ...
   - 🟡 **Warning:** Automation is degraded. Some items failing. Customer hasn't noticed yet.
   - 🟢 **Low:** Minor issue. No customer impact. Can fix during business hours.

3. **Communicate** (if 🔴 or 🟡):
   Send the customer a brief status update. Don't wait until it's fixed.
   ```
...
Notice: every prevention measure is free. Reliability isn't expensive. It's a discipline.

---

## 6.7 Stakeholder Management for Internal Champions

Not every quiet operator serves external customers. If you're a corporate employee automating internal processes, your "customer" is your leadership chain — and keeping them happy requires different skills.

### How to Report to Leadership

Leaders don't want to hear about your architecture. They want to hear about outcomes.
...
**Key principles for internal stakeholders:**
...
### Scaling from Pilot → Department → Company-Wide
...
- Replicate with minimal customization (you've productized internally)
...
- You become the internal "automation team" (even if it's just you)
...
**The "invisible automation" principle:** At every phase, the goal is the same — make the automation invisible. The best automation is the one people forget exists because it just works. They don't think about it the same way they don't think about the electricity powering the office. It's infrastructure. It runs. Results appear. Life is better.

When your automation becomes invisible, you've won. Nobody questions the budget for something that quietly saves them 60 hours a month.
...
**They require disproportionate support.** One customer takes 40% of your support time but generates 10% of your revenue. The math doesn't work.

**They don't respect boundaries.** Late-night messages, weekend calls, aggressive demands. This erodes your quality of life — the entire point of being a quiet operator.

**The ROI doesn't hold up.** If the automation isn't delivering clear value after 3 months of iteration, it's honest to say "this isn't the right fit."
...
Sunsetting is not failure. It's good engineering judgment. Document what you learned, archive the code, and move the resources to something that delivers more value.
...
- [ ] **Monitoring:** Slack/email alert fires within 5 minutes of any unhandled error. Heartbeat alert if automation doesn't complete within expected window.
...
- [ ] **Error rate:** Under 2%? If higher, what's causing it?
- [ ] **Volume trends:** Is processing volume growing, steady, or declining? (Declining might mean the customer's business is shrinking — or that they've stopped sending data.)
...
**End deliverable from this module:**
...
Now let's systematize everything and grow.
